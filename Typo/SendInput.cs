...
namespace Typo
{
    ...
    public class SendInputApi
    {
        ...
        public void SendText(string txt, BreakToken token)
        {
        ...
        /// <summary>
        /// Simulating pressing special key i.e: UP ARROW
        /// </summary>
        /// <param name="key">special key</param>
        public void SendSpecialKey(SpecialKeySCS key)
        {
        ...
        public void SendCombination(ExtendedSCS extendKey, char key)
        {
            ...
            inputs[0].type = 1;
            inputs[0].U.ki.wScan = (ScanCodeShort)extendKey;
            inputs[0].U.ki.dwFlags = KEYEVENTF.EXTENDEDKEY | KEYEVENTF.SCANCODE;

            inputs[1].type = 1;
            inputs[1].U.ki.wScan = keyMap[key];
            ...
            INPUT up = new INPUT();
            up.type = 1;
            up.U.ki.wScan = (ScanCodeShort)extendKey;
        ...
        private INPUT[] createInputArray(string txt)
        {
        ...
        Dictionary<char, ScanCodeShort> keyMap = new Dictionary<char, ScanCodeShort>(){
            ...
            { ' ',ScanCodeShort.SPACE} ,
            { '$',ScanCodeShort.NUMLOCK} ,
            { '#',ScanCodeShort.TAB} ,
            { '\n',ScanCodeShort.RETURN} ,
            { '@',ScanCodeShort.F6},
            {';', ScanCodeShort.OEM_1 },
            {',', ScanCodeShort.OEM_COMMA },
            {'.', ScanCodeShort.OEM_PERIOD },
            {'/', ScanCodeShort.OEM_2 },
            {'`', ScanCodeShort.OEM_3 },
            {'[', ScanCodeShort.OEM_4 },
            {'\\', ScanCodeShort.OEM_5 },
        ...
        /// <summary>
        /// Extented Keys Scan Code Shorts
        /// </summary>
        public enum ExtendedSCS : short
        {
            LWIN = 91,
            RWIN = 92,
            LSHIFT = 42,
        ...
        public enum SpecialKeySCS : short
        {
            UP = ScanCodeShort.UP,
            DOWN = ScanCodeShort.DOWN,
            LEFT = ScanCodeShort.LEFT,
            RIGTH = ScanCodeShort.RIGHT
        }
